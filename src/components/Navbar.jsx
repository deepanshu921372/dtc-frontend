    ...
    >
      <Toolbar>
        ...
        >
          ...
          {/* New Generation Request Button */}
          <Button color="inherit" component={Link} to="/generation-request">
            Generation Request
          </Button>
          {isLoggedIn ? (
        ...
        >
          ...
          {/* New Generation Request Menu Item */}
          <MenuItem onClick={handleMenuClose} component={Link} to="/generation-request">
            Generation Request
          </MenuItem>
          {isLoggedIn ? (
