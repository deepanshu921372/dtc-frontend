...
const Map = () => {
  ...
  return (
    <Grid container spacing={2} sx={{ padding: 2 }}>
      <Grid item xs={12} md={8} sx={{ height: "75vh" }}>
        <MapContainer style={{ height: "100%", width: "100%" }}>
          ...
          {locations.map((location, index) => (
            <Marker
              ...
              icon={
                index === 0
                  ? greenIcon // Starting point
                  : index === locations.length - 1
                  ? redIcon // Ending point
                  : defaultIcon // Intermediate points
              }
            >
          ...
          {locations.length > 1 && (
            <Polyline positions={polylinePositions} color="black" weight={3} />
          )}
        </MapContainer>
      </Grid>
        ...
        <Card sx={{ mb: 2, height: "auto", display: "flex", flexDirection: "column" }}>
          <CardContent sx={{ flex: 1, display: "flex", flexDirection: "column" }}>
            ...
            <Button
              ...
              endIcon={
                expandedCard === "route" ? <ExpandLessIcon /> : <ExpandMoreIcon />
              }
            >
            ...
            <Collapse in={expandedCard === "route"}>
              ...
              <Box sx={{ flex: 1, overflowY: "auto", mt: 1 }}>{renderStopList()}</Box>
            </Collapse>
          </CardContent>
        </Card>
